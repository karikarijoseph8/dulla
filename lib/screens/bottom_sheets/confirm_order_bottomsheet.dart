...
class ConfirmOrderBottomSheet extends StatelessWidget {
  const ConfirmOrderBottomSheet({
    super.key,
    required this.pickupOnPress,
    required this.destinationOnPress,
    required this.submitBtn,
  });

  final VoidCallback pickupOnPress;
  final VoidCallback destinationOnPress;
  ...
  Widget build(BuildContext context) {
    return SlidingUpPanel(
      ...
      panelBuilder: (controller) => ConfirmPanelWidget(
        ...
        submitBtn: submitBtn,
        destinationOnPress: destinationOnPress,
        pickupOnPress: pickupOnPress,
      ),
    );
  }
}
