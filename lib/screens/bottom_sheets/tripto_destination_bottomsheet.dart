...
class TripToDestinationBottomSheet extends StatelessWidget {
  const TripToDestinationBottomSheet({
    super.key,
  ...
  Widget build(BuildContext context) {
    return SlidingUpPanel(
      ...
      body: Container(),
      panelBuilder: (controller) => TripPanelWidget(
    ...
    return Row(
      children: [
        Column(
          children: [
            SvgPicture.asset(
              "assets/svgIcons/booking_pickup2.svg",
              width: 45,
            ),
            SvgPicture.asset(
              ...
              Container(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        "${driverEntity.vehicleManufacturer} - ${driverEntity.vehicleModel} ${driverEntity.vehicleColor}",
                        style: CustomFonts.urbanist(
